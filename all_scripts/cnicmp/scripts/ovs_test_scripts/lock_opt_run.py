...
def run_launch(lock_n1, lock_n2, lock_n3, lock_n4, lock_n5):#, lock_total):
    ...
    #exit()
    # start tests
    cmd = "python3 tenant-test.py ovs-ipvtap 400 1 0 0 kata > raw.log" #"bash /home/cni/cnicmp/scripts/time_kata_test_net.sh"
    os.system(cmd)
...
def run_launch_only_total(lock_total):
    ...
    #exit()
    # start tests
    cmd = "python3 tenant-test.py ovs-ipvtap 400 1 0 0 > raw.log" #"bash /home/cni/cnicmp/scripts/time_kata_test_net.sh"
    os.system(cmd)
    with open("./raw.log", "r") as f:
        raw_results = f.readlines()
    #raw_results = os.popen(cmd).readlines()
