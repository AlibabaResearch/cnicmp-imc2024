...
func ConfigureIface(ifName string, res *current.Result) error {
	...
	/**** cnicmp ****/
	cnilogger.RecordEnd(id, "linkSetUp", startT)
	/**** cnicmp ****/
	...
	/**** cnicmp ****/
	cnilogger.RecordEnd(id, "addAddr", startT)
	/**** cnicmp ****/
	...
	/**** cnicmp ****/
	cnilogger.RecordEnd(id, "settleAddr", startT)
	/**** cnicmp ****/
	...
	/**** cnicmp ****/
	cnilogger.RecordEnd(id, "addRoutes", startT)
	/**** cnicmp ****/
