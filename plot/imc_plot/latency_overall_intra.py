...
latency = [
    ...
    [15.9, 16, 15.9, 15.7, 17.1, 16.0],
    [16.9, 17, 15.9, 16.7, 17.4, 15.0]
] #todo
...
throughput =[
    ...
    [26.3, 26.8, 28.7],
    [20.4, 19.7, 19.9], # vhost not available
    [31.0, 30.9, 30.6],
    [31.0, 31.6, 32.5],
...
plt.tight_layout()
plt.savefig("./imc_plot/figs/latency_overall_intra.pdf")
plt.show()