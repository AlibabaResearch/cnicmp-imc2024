...
log_id =[20230907073151,    20240122011910, 20240122015716,        20230828221909,     
...
fig_path = "./rotate_figs_fixed/" + ["./kata-no-net-2.png", "./kata-net-veth-2.png", "./kata-net-ipvlan-2.png", "./kata-net-ipvtap-2.png", "./kata-net-vhost.png",
